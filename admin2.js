...
myApp.config(['NgAdminConfigurationProvider', function (nga) {
    ...
    var companies = nga.entity('Companies');
    var parkings = nga.entity('Parkings');
    var parkingLots = nga.entity('ParkingLots');
    var parkingSubLots = nga.entity('ParkingSubLots');
    var pricingSlots = nga.entity('PricingSlots');
    var priceGrids = nga.entity('PriceGrids');
    var receiptContents = nga.entity('ReceiptContents');
    var focReasons = nga.entity('FocReasons').identifier(nga.field('reasonTitle'));
...
myApp.config(['RestangularProvider', function (RestangularProvider) {
    ...
    RestangularProvider.setDefaultHeaders({'Authorization': '0jFnBdq0HGbZPQZYsUkE76uvSWMkWWoG16zXQ6JhBqWF7gXOtUtUikv2lnm5kujb'});
    ...
    function Get(yourUrl) {
        var Httpreq = new XMLHttpRequest();
        Httpreq.open("GET", yourUrl, false);
        Httpreq.setRequestHeader("Authorization", "0jFnBdq0HGbZPQZYsUkE76uvSWMkWWoG16zXQ6JhBqWF7gXOtUtUikv2lnm5kujb");
        Httpreq.send(null);
        return Httpreq.responseText;
    };
